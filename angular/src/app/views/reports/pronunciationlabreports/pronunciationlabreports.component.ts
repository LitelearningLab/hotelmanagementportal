...
@Component({
  selector: 'app-pronunciationlabreports',
  templateUrl: './pronunciationlabreports.component.html',
  styleUrls: ['./pronunciationlabreports.component.scss']
})
export class PronunciationlabreportsComponent {
  settings: any;
  ...
  pageTitle: string = 'Pronunciation Lab Reports  ';
        ...
        columns: {
          ...
          username: {
            ...
            valuePrepareFunction: (value, row) => {
              return `<a href="#/app/reports/pronunciationlabreports/${row.userid}" style="text-decoration:none;">${value ? value : '-'}</a>`;
            }
