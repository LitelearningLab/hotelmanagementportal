...
@Component({
  selector: 'app-pronunciationreportuser',
  templateUrl: './pronunciationreportuser.component.html',
  styleUrls: ['./pronunciationreportuser.component.scss']
})
export class PronunciationreportuserComponent {
  settings: any;
  ...
  ngOnInit(): void {
    ...
    this.ActivatedRoute.paramMap.subscribe((result)=>{
      ...
      this.pronunciationlabreportuseroverall(this.userid)
    })
  

  };
  pronunciationlabreportuseroverall(id:any){
    this.apiService.CommonApi(Apiconfig.pronunciatonlabuseroverall.method,Apiconfig.pronunciatonlabuseroverall.url,{userid:id}).subscribe((result)=>{
      console.log(result)
      if(result.status){
        ...
        columns: {
          ...
          date: {
            ...
            valuePrepareFunction: (value, row) => {
              return `<a href="#/app/reports/pronunciationlabreports/${this.userid}/${row.date}" style="text-decoration:none;">${value ? value : '-'}</a>`;
            }
