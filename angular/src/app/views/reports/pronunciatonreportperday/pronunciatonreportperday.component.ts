...
@Component({
  selector: 'app-pronunciatonreportperday',
  templateUrl: './pronunciatonreportperday.component.html',
  styleUrls: ['./pronunciatonreportperday.component.scss']
})
export class PronunciatonreportperdayComponent {
  settings: any;
  ...
  ngOnInit(): void {
    ...
    this.ActivatedRoute.paramMap.subscribe((result)=>{
      ...
      this.pronunciationlabreportofaday(this.userid,this.date)
    })
  

  };
  pronunciationlabreportofaday(id:any,date:any){
    this.apiService.CommonApi(Apiconfig.pronunciationperday.method,Apiconfig.pronunciationperday.url,{userid:id,date:date}).subscribe((result)=>{
      console.log(result)
      if(result.status){
        ...
        columns: {
          ...
          word: {
            ...
            valuePrepareFunction: (value, row) => {
              return `<a href="#/app/reports/pronunciationlabreports/${this.userid}/${row.date}/${row.word}" style="text-decoration:none;">${value ? value : '-'}</a>`;
            }
