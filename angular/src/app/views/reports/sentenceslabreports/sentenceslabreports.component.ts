...
@Component({
  selector: 'app-sentenceslabreports',
  templateUrl: './sentenceslabreports.component.html',
  styleUrls: ['./sentenceslabreports.component.scss']
})
export class SentenceslabreportsComponent {
  settings: any;
  ...
  ngOnInit(): void {
    ...
    const storedData = localStorage.getItem('speechdata');
    if (storedData) {
  ...
  clearForm(){
    ...
    localStorage.removeItem('speechdata');
  ...
  onFilter(){
    ...
    if (this.storeddata) {
      ...
      this.getpronounciatonlist(this.storeddata);
      return;
    }
    if(this.filterForm.valid){
      ...
      localStorage.setItem('speechdata', JSON.stringify(data));
        ...
        columns: {
          ...
          learnerName: {
            ...
            valuePrepareFunction: (value, row) => {
              return `<a href="#/app/reports/sentenceslabreports/${row.userid}" style="text-decoration:none;">${value ? value : '-'}</a>`;
            }
