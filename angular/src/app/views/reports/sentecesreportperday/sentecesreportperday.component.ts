...
@Component({
  selector: 'app-sentecesreportperday',
  templateUrl: './sentecesreportperday.component.html',
  styleUrls: ['./sentecesreportperday.component.scss']
})
export class SentecesreportperdayComponent {
  settings: any;
  ...
  ngOnInit(): void {
    ...
    this.ActivatedRoute.paramMap.subscribe((result)=>{
      ...
      this.sentenceslabreportofaday(this.userid,this.date,this.senarios)
    })
  

  };
  sentenceslabreportofaday(id:any,date:any,senarios:any){
    this.apiService.CommonApi(Apiconfig.sentenceslabforsenarios.method,Apiconfig.sentenceslabforsenarios.url,{userid:id,scenario:senarios,date:date}).subscribe((result)=>{
      console.log(result)
      if(result.status){
        ...
        columns: {
          ...
          sentences: {
            ...
            valuePrepareFunction: (value, row) => {
              return `<a href="#/app/reports/sentenceslabreports/${this.userid}/${this.senarios}/${this.date}/${value}" style="text-decoration:none;">${value ? value : '-'}</a>`;
            }
