...
@Component({
  selector: 'app-pronunciationreportwords',
  templateUrl: './pronunciationreportwords.component.html',
  styleUrls: ['./pronunciationreportwords.component.scss'],
  
})
export class PronunciationreportwordsComponent {
  settings: any;
  ...
  ngOnInit(): void {
    ...
    this.ActivatedRoute.paramMap.subscribe((result)=>{
      ...
      this.word=result.get("word")
      console.log("++++++++++++++++++++++++++++++++++++++++++")
      console.log(this.userid)
      console.log(this.date)
      
     
      this.pronunciationlabreportofaday(this.userid,this.date,this.word)
    })
  

  };
  pronunciationlabreportofaday(id:any,date:any,word:any){
    this.apiService.CommonApi(Apiconfig.pronunciationreportforword.method,Apiconfig.pronunciationreportforword.url,{userid:id,date:date,word:this.word}).subscribe((result)=>{
      console.log(result)
      if(result.status){
