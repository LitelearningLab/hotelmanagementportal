...
@Component({
  selector: 'app-sentecesreportuser',
  templateUrl: './sentecesreportuser.component.html',
  styleUrls: ['./sentecesreportuser.component.scss']
})
export class SentecesreportuserComponent {
  settings: any;
  ...
  senteceslabreportuser(id:any){
    this.apiService.CommonApi(Apiconfig.sentenceslabuserdataall.method,Apiconfig.sentenceslabuserdataall.url,{userid:id}).subscribe((result)=>{
      console.log(result)
      if(result.status){
        ...
        columns: {
          ...
          date: {
            ...
            valuePrepareFunction: (value, row) => {
              return `<a href="#/app/reports/sentenceslabreports/${this.userid}/${row.date}" style="text-decoration:none;">${value ? value : '-'}</a>`;
            }
