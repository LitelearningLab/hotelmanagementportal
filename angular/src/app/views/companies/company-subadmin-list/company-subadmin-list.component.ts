...
@Component({
  selector: 'app-company-subadmin-list',
  templateUrl: './company-subadmin-list.component.html',
  styleUrls: ['./company-subadmin-list.component.scss']
})
export class CompanySubadminListComponent {
  settings: any;
  ...
  editUrl: string = '/app/companies/editsubadmin/';
