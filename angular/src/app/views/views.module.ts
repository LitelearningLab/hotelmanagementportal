...
@NgModule({
  declarations: [
    ViewsComponent, SpinnerComponent, BrandComponent, BannersComponent, UnitsComponent, OrdersComponent, TaxmanagementComponent, /* MapViewComponent, */ DocumentManagementComponent, CancellationreasonComponent, AdminearningsComponent, TimeSlotsComponent, DriversComponent, CityManagementComponent, WalkthroughComponent, 
  ],
  imports: [
    CommonModule,
    ViewsRoutingModule,
