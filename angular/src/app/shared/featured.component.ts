...
@Component({
    ...
    template: `
     <span style="cursor: pointer;" class="btn app-close" *ngIf="rowData && rowData.feature == 1" (click)="confirmModal.show()" >Featured</span><span style="cursor: pointer;" class="btn app-closedd" (click)="confirmModal.show()" *ngIf="rowData && rowData.feature == 0">Un Featured</span>
